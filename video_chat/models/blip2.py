...
class Blip2Base(nn.Module):
    ...
    def init_tokenizer(cls):
        tokenizer = BertTokenizer.from_pretrained("bert-base-uncased", cache_dir= "/apdcephfs_cq10/share_1275055/lijinmin/datasets/Video/ChatGPT/ckpt/transformer")
    ...
    def init_Qformer(
        ...
        encoder_config = BertConfig.from_pretrained("bert-base-uncased", cache_dir= "/apdcephfs_cq10/share_1275055/lijinmin/datasets/Video/ChatGPT/ckpt/transformer")
