...
class VideoChatGPTLlamaModel(LlamaModel):
    ...
    def forward(
        ...
        if (input_ids.shape[1] != 1 or self.training) and video_spatio_temporal_features is not None:
            ...
            # print('TTTTTT inputs_embeds:', inputs_embeds.shape)
...
class VideoChatGPTLlamaForCausalLM(LlamaForCausalLM):
    ...
    def forward(
        ...
        # print('9. input_ids', input_ids.shape)
        # print('10. attention_mask', attention_mask.shape)
        # if past_key_values:
        #     for i, past_key_value in enumerate(past_key_values):
        #         for j, past_key in enumerate(past_key_value):
        #             print(f'11 {i}, {j}. past_key', past_key.shape)
        #             # 11 31, 0. past_key torch.Size([1, 32, 462, 128])
        #             # 11 31, 1. past_key torch.Size([1, 32, 462, 128])
        # else:
        #     print('11. past_key_values none')
        # print('12. inputs_embeds', inputs_embeds)
        # print('13. use_cache', use_cache)
        # print('14. output_attentions', output_attentions)
        # print('15. output_hidden_states', output_hidden_states)
        # print('16. return_dict', return_dict)
        # print('17. video_spatio_temporal_features', video_spatio_temporal_features.shape)

        # 9. input_ids torch.Size([1, 447])
        # 10. attention_mask torch.Size([1, 447])
        # 11. past_key_values none
        # 12. inputs_embeds None
        # 13. use_cache True
        # 14. output_attentions False
        # 15. output_hidden_states False
        # 16. return_dict True
        # 17. video_spatio_temporal_features torch.Size([1, 356, 1024])
        # 9. input_ids torch.Size([1, 1])
        # 10. attention_mask torch.Size([1, 448])
        # 11. past_key_values not none
        # 12. inputs_embeds None
        # 13. use_cache True
        # 14. output_attentions False
        # 15. output_hidden_states False
        ...
        # print('9. ', input_ids.shape, outputs[0].shape) #torch.Size([1, 443]) torch.Size([1, 443, 4096])
        ...
        # print('7. logits', logits.shape) #[1, 443, 32006]
        ...
        # print('8. causalLMoutput.logits', causalLMoutput.logits.shape)
