...
from video_chatgpt.inference_flow_mask_select import video_chatgpt_infer, video_chatgpt_attack_flow_select
import torch
import cv2
import numpy as np
...
def run_inference(args):
    ...
    for sample in tqdm(gt_contents):
        ...
        if args.mask_type == 'flow' or args.mask_type == 'flow_select':
        ...
        if args.mask_type == 'flow_select':
            output_attack,image_clean, image_attack, delta_attack, modifier = video_chatgpt_attack_flow_select(video_frames, question, conv_mode, model, vision_tower,
